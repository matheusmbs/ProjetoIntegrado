...
public class Avaliador {
   ...
   public Avaliador (int id, String nome, String sobrenome, Date dataNascimento, String telefone, String sexo,  String senha){
     this.id = id;
     this.nome = nome;
  ...
  public void setSobrenome (String sobrenome){
   ...
   //implementando o banco
     ...
     public void incluir (Connection conn){
      String sqlInsert = "INSERT INTO avaliador (id,nome, sobrenome, dataNascimento, telefone, sexo, senha) VALUES (?,?,?,?,?,?,?)";
